...
module.exports = (createdAt, updatedAt) => {
    ...
    if (createdAtSecond < 60) createdAtAgo = `${Math.floor(createdAtSecond)} seconds ago`;
    ...
    if (updatedAtSecond < 60) updatedAtAgo = `${Math.floor(updatedAtSecond)} seconds ago`;
    ...
    console.log({ createdAt : createdAtAgo, updatedAt: updatedAtAgo })
